...
<ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="index.php?option=login1"><span class="glyphicon glyphicon-log-in"></span>user Login</a></li>
      <li><a href="index.php?option=login2"><span class="glyphicon glyphicon-log-in"></span>admin Login</a></li>
    </ul>
